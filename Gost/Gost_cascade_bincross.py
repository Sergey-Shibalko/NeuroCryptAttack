...
def make_net(reg_param=0.0001, final_activation='sigmoid'):
    ...
    dense3 = Dense(128, kernel_regularizer=l2(reg_param))(inp1)
    dense3 = BatchNormalization()(dense3)
    dense3 = Activation('relu')(dense3)
    inp2 = concatenate([inp1, dense3], axis=1)
    dense4 = Dense(256, kernel_regularizer=l2(reg_param))(inp2)
    dense4 = BatchNormalization()(dense4)
    dense4 = Activation('relu')(dense4)
    inp3 = concatenate([inp2, dense4], axis=1)
    dense5 = Dense(128, kernel_regularizer=l2(reg_param))(inp3)
    dense5 = BatchNormalization()(dense5)
    dense5 = Activation('relu')(dense5)
    inp4 = concatenate([inp3, dense5])
    out = Dense(64, activation=final_activation, kernel_regularizer=l2(reg_param))(inp4)
